...
import { IsAssetIdSupportedConstraint, UserIdValidationMiddleware } from '@shared/utils/validation';
...
@Module({
  controllers: [WalletServiceController, UserAssetsController, SupportedValuesController],
  imports: [HttpModule, LoggingModule, FileManagementModule],
  providers: [WalletService, UserAssetsService, RateService, SupportedValuesService, IsAssetIdSupportedConstraint]
})
